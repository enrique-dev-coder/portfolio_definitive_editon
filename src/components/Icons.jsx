...
export const TwitterIcon = () => {
  return (
    <SVGIcon width="1.23em" height="1em" viewBox="0 0 256 209">
      {" "}
...
export const LinkArrow = () => {
  return (
    <SVGIcon className="w-8 mr-2" width="24" height="24" viewBox="0 0 24 24">
...
export const WhatsIon = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      viewBox="0 0 24 24"
      fill="none"
      className={`fill-dark dark:fill-light  ${className}`}
      {...rest}
    >
...
export const ChangeIcon = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
      viewBox="0 0 24 24"
      className={`fill-light dark:fill-dark ${className}`}
      {...rest}
      fill="none"
    >
      <path d="M12.07 18.577L14.477 16.175L12.069 13.773L11.442 14.4L12.825 15.783C12.0503 15.7863 11.3623 15.6953 10.761 15.51C10.159 15.3233 9.67633 15.049 9.313 14.687C8.94167 14.315 8.662 13.893 8.474 13.421C8.286 12.949 8.192 12.4773 8.192 12.006C8.192 11.7227 8.22333 11.4393 8.286 11.156C8.34867 10.8727 8.44 10.604 8.56 10.35L7.883 9.75C7.68967 10.1027 7.54533 10.468 7.45 10.846C7.35533 11.224 7.308 11.6087 7.308 12C7.308 12.594 7.42333 13.1807 7.654 13.76C7.88467 14.3393 8.22567 14.857 8.677 15.313C9.12833 15.771 9.72133 16.111 10.456 16.333C11.1907 16.5557 11.945 16.669 12.719 16.673L11.442 17.95L12.07 18.577ZM16.137 14.25C16.3303 13.8973 16.4743 13.532 16.569 13.154C16.6643 12.776 16.712 12.3913 16.712 12C16.712 11.408 16.5973 10.8197 16.368 10.235C16.1387 9.65033 15.7953 9.13233 15.338 8.681C14.8933 8.223 14.3017 7.88367 13.563 7.663C12.8237 7.443 12.0693 7.333 11.3 7.333L12.577 6.05L11.95 5.423L9.542 7.825L11.95 10.227L12.577 9.6L11.188 8.212C11.9587 8.212 12.648 8.30567 13.256 8.493C13.8633 8.681 14.3483 8.957 14.711 9.321C15.0743 9.68433 15.351 10.1027 15.541 10.576C15.7317 11.0487 15.827 11.5213 15.827 11.994C15.827 12.2773 15.796 12.5607 15.734 12.844C15.672 13.1273 15.5807 13.396 15.46 13.65L16.137 14.25ZM12.003 21C10.759 21 9.589 20.764 8.493 20.292C7.39767 19.8193 6.44467 19.178 5.634 18.368C4.82333 17.5587 4.18167 16.6067 3.709 15.512C3.23633 14.4173 3 13.2477 3 12.003C3 10.759 3.236 9.589 3.708 8.493C4.18067 7.39767 4.822 6.44467 5.632 5.634C6.44133 4.82333 7.39333 4.18167 8.488 3.709C9.58267 3.23633 10.7523 3 11.997 3C13.241 3 14.411 3.236 15.507 3.708C16.6023 4.18067 17.5553 4.822 18.366 5.632C19.1767 6.44133 19.8183 7.39333 20.291 8.488C20.7637 9.58267 21 10.7523 21 11.997C21 13.241 20.764 14.411 20.292 15.507C19.8193 16.6023 19.178 17.5553 18.368 18.366C17.5587 19.1767 16.6067 19.8183 15.512 20.291C14.4173 20.7637 13.2477 21 12.003 21Z" />
    </svg>
  );
};
